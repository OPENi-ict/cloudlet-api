...
var createCloudlet = function(msg){
   ...
   return {
      'dao_actions'      : [
         { 'action' : 'CREATE', 'database': cloudletId },
         { 'action' : 'POST',   'database': cloudletId, 'object_name'  : 'meta', 'object_data' : cloudletDBObj }
      ],
...
var exportCloudlet = function(msg){
   ...
   return {
      'dao_actions'      : [
         { 'action' : 'FETCH', 'database': cloudletId, 'object_name': {}, 'mongrel_resp' : responseObject }
      ],
      'mongrel_resp' : responseObject,
      'clients'      : [
         {'uuid' : msg.uuid, 'connId' : msg.connId }
